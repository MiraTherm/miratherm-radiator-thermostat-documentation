...
The software presented in this paper uses the eQ-3 eqiva Bluetooth Smart Radiator Thermostat (CC-RT-M-BLE-EQ) \cite{eQ3AG.05.2018} as a functional reference for defining its scope.

\subsection{MVP Pattern}
The Model-View-Presenter (MVP) pattern is a derivative of the classic Model-View-Controller (MVC) pattern originating from Smalltalk-80 \cite{Burbeck.1992}. MVP was formalized by Potel at Taligent, Inc. as a generalization of MVC that decomposes an application's design into two fundamental domains: \textit{Data Management} and \textit{User Interface} \cite{Potel.1996}.
...
\begin{enumerate}
    ...
    \item \textit{How do I change my data?} --- answered by \textbf{Commands}, which represent operations that can be performed on selections.
\end{enumerate}
