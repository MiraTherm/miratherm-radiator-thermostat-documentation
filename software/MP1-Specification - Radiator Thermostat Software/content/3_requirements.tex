...
The system shall integrate a rotary encoder KY-040 via \ac{qdec} interface and a \ac{gpio} pin.
...
The system shall measure the motor current consumption using an \ac{adc} channel connected to a $1 \unit{Ω}$ shunt resistor in series with the motor circuit.
...
\begin{itemize}
    ...
    \item \textbf{Boost Mode}: Described in REQ 16.
\end{itemize}
